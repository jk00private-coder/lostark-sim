...
export const NAMES = {
  [ID.SNH_01]: '질서 해 [1]피니셔', [ID.SNH_02]: '질서 해 [2]매니페스트', [ID.SNH_03]: '질서 해 [3]붉은 날개',
  [ID.SND_01]: '질서 해 [1]차지 인핸스', [ID.SND_02]: '질서 해 [2]브랜디쉬', [ID.SND_03]: '질서  [3]에이펙스',

  [ID.MNH_01]: '질서 달 [1]노바 플레임', [ID.MNH_02]: '질서 달 [2]리버레이션', [ID.MNH_03]: '질서 달 [3]복수귀',
  [ID.MND_01]: '질서 달 [1]위압', [ID.MND_02]: '질서 달 [2]플러리쉬', [ID.MND_03]: '질서 달 [3]도미넌트',
  
  [ID.STH_01]: '질서 별 [1]라스트 스탠드', [ID.STH_02]: '질서 별 [2]엑스큐셔너', [ID.STH_03]: '질서 별 [3]추격 시작',
  [ID.STD_01]: '질서 별 [1]그랜드 피날레', [ID.STD_02]: '질서 별 [2]일당백', [ID.STD_03]: '질서 별 [3]파멸',
} as const;

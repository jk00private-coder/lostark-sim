...
export const NAMES = {
  [ID.AN_1]: '주스탯 +{v1}', [ID.AN_2]: '체력 +{v1}',
  [ID.AN_3]: '추가 피해 +{v1}%', [ID.AN_4]: '피해 증가 +{v1}%', [ID.AN_8]: '공격력 +{v1}',
  [ID.AN_9]: '무기 공격력 +{v1}',

  [ID.AE_1]: '주스탯 +{v1}', [ID.AE_2]: '체력 +{v1}',
  [ID.AE_3]: '공격력 +{v1}%', [ID.AE_4]: '무기 공격력 +{v1}%', [ID.AE_8]: '공격력 +{v1}',
  [ID.AE_9]: '무기 공격력 +{v1}',

  [ID.AR_1]: '주스탯 +{v1}', [ID.AR_2]: '체력 +{v1}',
  [ID.AR_3]: '치명타 적중률 +{v1}%', [ID.AR_4]: '치명타 피해 +{v1}%', [ID.AR_8]: '공격력 +{v1}',
  [ID.AR_9]: '무기 공격력 +{v1}',

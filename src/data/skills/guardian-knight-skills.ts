...
export const GUARDIAN_KNIGHT_SKILLS_DB: SkillData[] = [
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        source: 'TRIPOD', id: 'GK_CLEAVE_A1', name: {text: '피해증폭'}, iconPath: '',
        slot: 1, index: 1,
        effects: [{
          type: 'ENEMY_DMG_TAKEN', value: { value: 0.06 },
          target: { skillIds: [GK_SKILL_IDS.CLEAVE] },
        }],
      },
      {
        source: 'TRIPOD', id: 'GK_CLEAVE_A2', name: {text:  '돌진'}, iconPath: '',
        slot: 1, index: 2,
        memo: [{ type: '이동 거리 증가', value: 4 }],
      },
      {
        source: 'TRIPOD', id: 'GK_CLEAVE_A3', name: {text:  '재빠른 손놀림'}, iconPath: '',
        slot: 1, index: 3,
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        source: 'TRIPOD', id: 'GK_CLEAVE_B1', name: {text:  '증강'}, iconPath: '',
        slot: 2, index: 1,
        effects: [{
          type: 'DMG_INC', value:{value: 0.04},
          target: { skillIds: [GK_SKILL_IDS.CLEAVE] },
        }],
        memo: [{ type: '기운 추가 회복', value: 1 }],
      },
      {
        source: 'TRIPOD', id: 'GK_CLEAVE_B2', name: {text:  '약육강식'}, iconPath: '',
        slot: 2, index: 2,
        memo: [{ type: '하급 및 일반 몬스터에게 주는 피해', value: 1.2 }],
      },
      {
        source: 'TRIPOD', id: 'GK_CLEAVE_B3', name: {text:  '약점 포착'}, iconPath: '',
        slot: 2, index: 3,
        effects: [{
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        source: 'TRIPOD', id: 'GK_CLEAVE_C1', name: {text:  '화염 폭풍'}, iconPath: '',
        slot: 3, index: 1,
        effects: [{
          type: 'DMG_INC', value:{value: 0.6},
          target: { skillIds: [GK_SKILL_IDS.CLEAVE] },
      ...
      {
        source: 'TRIPOD', id: 'GK_CLEAVE_C2', name: {text: '휩쓸기'}, iconPath: '',
        slot: 3, index: 2,
        effects: [{
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        source: 'TRIPOD', id: 'GK_RENDING_FINISHER_A1', name: {text: '재빠른 손놀림'}, iconPath: '',
        slot: 1, index: 1,
        memo: [{ type: '시전 속도 증가', value: 0.15 }],
      },
      {
        source: 'TRIPOD', id: 'GK_RENDING_FINISHER_A2', name: {text: '단단한 비늘'}, iconPath: '',
        slot: 1, index: 2,
        memo: [{ type: '스킬 시전 중 받는 피해 감소', value: 0.2 }],
      },
      {
        source: 'TRIPOD', id: 'GK_RENDING_FINISHER_A3', name: {text: '정면 승부'}, iconPath: '',
        slot: 1, index: 3,
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        source: 'TRIPOD', id: 'GK_RENDING_FINISHER_B1', name: {text: '응축된 힘'}, iconPath: '',
        slot: 2, index: 1,
        link    : { slot: 3, index: 1 },
        overrides: { typeId: 'CHARGE', superArmorId: 'PUSH_IMMUNE' },
        effects: [{
          type: 'DMG_INC', value:{value: 0.5},
          target: { skillIds: [GK_SKILL_IDS.RENDING_FINISHER] },
        }],
      },
      {
        source: 'TRIPOD', id: 'GK_RENDING_FINISHER_B2', name: {text: '약점 포착'}, iconPath: '',
        slot: 2, index: 2,
        link   : { slot: 3, index: 1 },
        effects: [{
          type: 'DMG_INC', value:{value: 0.7},
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        source: 'TRIPOD', id: 'GK_RENDING_FINISHER_C1', name: {text: '깨어난 본능'}, iconPath: '',
        slot: 3, index: 1,
        effects: [
          {
            type: 'DMG_INC', value:{value: 0.5},
          ...
          },
          {
            ...
            type: 'GK_QI_DMG' as GkEffectTypeId, value:{value: 0.1},
            target: { skillIds: [GK_SKILL_IDS.RENDING_FINISHER] },
          },
        ],
      },
      {
        source: 'TRIPOD', id: 'GK_RENDING_FINISHER_C2', name: {text:  '공간절삭'}, iconPath: '',
        slot: 3, index: 2,
        effects: [{
  ...
  // ──────────────────────────────────────────────────────────
  {
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        source: 'TRIPOD', id: 'GK_EXPLOSION_FINISHER_A1', name: {text:  '재빠른 손놀림'}, iconPath: '',
        slot: 1, index: 1,
        memo: [{ type: '시전 속도 증가', value: 0.1 }],
      },
      {
        source: 'TRIPOD', id: 'GK_EXPLOSION_FINISHER_A2', name: {text:  '단단한 비늘'}, iconPath: '',
        slot: 1, index: 2,
        memo: [{ type: '스킬 시전 중 받는 피해 감소', value: 0.2 }],
      },
      {
        source: 'TRIPOD', id: 'GK_EXPLOSION_FINISHER_A3', name: {text:  '뇌진탕'}, iconPath: '',
        slot: 1, index: 3,
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        source: 'TRIPOD', id: 'GK_EXPLOSION_FINISHER_B1', name: {text:  '응축된 힘'}, iconPath: '',
        slot: 2, index: 1,
        link    : { slot: 3, index: 1 },
        overrides: { typeId: 'CHARGE', superArmorId: 'PUSH_IMMUNE' },
        effects: [{
          type: 'DMG_INC', value:{value: 0.7},
          target: { skillIds: [GK_SKILL_IDS.EXPLOSION_FINISHER] },
        }],
      },
      {
        source: 'TRIPOD', id: 'GK_EXPLOSION_FINISHER_B2', name: {text:  '약점 포착'}, iconPath: '',
        slot: 2, index: 2,
        link   : { slot: 3, index: 2 },
        effects: [{
          type: 'DMG_INC', value:{value: 0.7},
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        source: 'TRIPOD', id: 'GK_EXPLOSION_FINISHER_C1', name: {text:  '붉은 심장'}, iconPath: '',
        slot: 3, index: 1,
        effects: [{
      ...
      {
        source: 'TRIPOD', id: 'GK_EXPLOSION_FINISHER_C2', name: {text:  '푸른 심장'}, iconPath: '',
        slot: 3, index: 2,
        effects: [
          {
            type: 'DMG_INC', value:{value: 0.5},
          ...
          {
            // 기운 소모 개수 증가
            type: 'GK_QI_COST' as GkEffectTypeId, value:{value: 4},
            target: { skillIds: [GK_SKILL_IDS.EXPLOSION_FINISHER] },
          },
        ],
      },

...
export const ID = {
  CLEAVE: {
    ...
    T2_1: BASE + 1121, T2_2: BASE + 1121, T2_3: BASE + 1121,
...
export const GUARDIAN_KNIGHT_SKILLS_DB: SkillData[] = [
  ...
  {
    id: ID.CLEAVE.BODY,
    name: { text: NAMES[ID.CLEAVE.BODY] },
    ...
    tripods: [
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.CLEAVE.T2_1, name: { text: NAMES[ID.CLEAVE.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.CLEAVE.T2_1}.webp`,
        slot: 2, index: 1,
        effects: [{
          type: 'DMG_INC', value: { value: 0.4 },
          target: { skillIds: [ NAMES[ID.CLEAVE.BODY] ] }
        }],
        memo: [{ type: '기운 추가 회복', value: 1 }]
      },
      {
        id: ID.CLEAVE.T2_2, name: { text: NAMES[ID.CLEAVE.T2_2] },
        iconPath: `/images/skills/guardian-knight/${ID.CLEAVE.T2_2}.webp`,
        slot: 2, index: 2,
        memo: [{ type: '하급 및 일반 몬스터에게 주는 피해', value: 1.2 }]
      },
      {
        id: ID.CLEAVE.T2_3, name: { text: NAMES[ID.CLEAVE.T2_3] },
        iconPath: `/images/skills/guardian-knight/${ID.CLEAVE.T2_3}.webp`,
        slot: 2, index: 3,
        effects: [{
          type: 'DMG_INC', value: { value: 0.6 },
          target: { skillIds: [ NAMES[ID.CLEAVE.BODY] ] }
        }]
      },
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.CLEAVE.T3_1, name: { text: NAMES[ID.CLEAVE.T3_1] },
      ...
      {
        id: ID.CLEAVE.T3_2, name: { text: NAMES[ID.CLEAVE.T3_2] },
        iconPath: `/images/skills/guardian-knight/${ID.CLEAVE.T3_2}.webp`,
        slot: 3, index: 2,
        effects: [{
          type: 'DMG_INC', value: { value: 0.7 },
          target: { skillIds: [ NAMES[ID.CLEAVE.BODY] ] }
        }],
  ...
  // ────── 와일드 어퍼 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.WILD_UPPERCUT.BODY] },
    ...
    tripods: [
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.WILD_UPPERCUT.T2_1, name: { text: NAMES[ID.WILD_UPPERCUT.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.WILD_UPPERCUT.T2_1}.webp`,
        slot: 2, index: 1,
        effects: [{
          type: 'DMG_INC', value: { value: 0.4 },
          target: { skillIds: [ NAMES[ID.WILD_UPPERCUT.BODY] ] }
        }],
        memo: [{ type: '돌진 거리', value: 4 }]
      },
      {
        id: ID.WILD_UPPERCUT.T2_2, name: { text: NAMES[ID.WILD_UPPERCUT.T2_2] },
        iconPath: `/images/skills/guardian-knight/${ID.WILD_UPPERCUT.T2_2}.webp`,
        slot: 2, index: 2,
        effects: [{
          type: 'DMG_INC', value: { value: 0.33 },
          target: { skillIds: [ NAMES[ID.WILD_UPPERCUT.BODY] ] }
        }],
        overrides: { typeId: 'NORMAL' }
      },
      {
        id: ID.WILD_UPPERCUT.T2_3, name: { text: NAMES[ID.WILD_UPPERCUT.T2_3] },
        iconPath: `/images/skills/guardian-knight/${ID.WILD_UPPERCUT.T2_3}.webp`,
        slot: 2, index: 3,
        effects: [{
          type: 'DMG_INC', value: { value: 0.9 },
          target: { skillIds: [ NAMES[ID.WILD_UPPERCUT.BODY] ] }
        }]
      },
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.WILD_UPPERCUT.T3_1, name: { text: NAMES[ID.WILD_UPPERCUT.T3_1] },
        iconPath: `/images/skills/guardian-knight/${ID.WILD_UPPERCUT.T3_1}.webp`,
        slot: 3, index: 1,
        effects: [{
          type: 'DMG_INC', value: { value: 0.8 },
          target: { skillIds: [ NAMES[ID.WILD_UPPERCUT.BODY] ] }
        }],
      },
      {
        id: ID.WILD_UPPERCUT.T3_2, name: { text: NAMES[ID.WILD_UPPERCUT.T3_2] },
  ...
  {
    id: ID.THRUST.BODY,
    name: { text: NAMES[ID.THRUST.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.THRUST.T1_1, name: { text: NAMES[ID.THRUST.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.THRUST.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '적 받는 피해 증가', value: 0.06 }]
      },
      {
        id: ID.THRUST.T1_2, name: { text: NAMES[ID.THRUST.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.THRUST.T1_2}.webp`,
        slot: 1, index: 2,
        overrides: { destruction: 1 }
      },
      {
        id: ID.THRUST.T1_3, name: { text: NAMES[ID.THRUST.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.THRUST.T2_1, name: { text: NAMES[ID.THRUST.T2_1] },
      ...
      {
        id: ID.THRUST.T2_2, name: { text: NAMES[ID.THRUST.T2_2] },
        iconPath: `/images/skills/guardian-knight/${ID.THRUST.T2_2}.webp`,
        slot: 2, index: 2,
        effects: [{
          type: 'DMG_INC', value: { value: 0.4 },
          target: { skillIds: [ NAMES[ID.THRUST.BODY] ] }
        }]
      },
      {
        id: ID.THRUST.T2_3, name: { text: NAMES[ID.THRUST.T2_3] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.THRUST.T3_1, name: { text: NAMES[ID.THRUST.T3_1] },
        iconPath: `/images/skills/guardian-knight/${ID.THRUST.T3_1}.webp`,
        slot: 3, index: 1,
        effects: [{
          type: 'DMG_INC', value: { value: 1.1 },
          target: { skillIds: [ NAMES[ID.THRUST.BODY] ] }
        }]
      },
      {
        id: ID.THRUST.T3_2, name: { text: NAMES[ID.THRUST.T3_2] },
  ...
  // ────── 길로틴 스핀 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.GUILLOTINE_SPIN.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.GUILLOTINE_SPIN.T1_1, name: { text: NAMES[ID.GUILLOTINE_SPIN.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.GUILLOTINE_SPIN.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '하급 및 일반 몬스터에게 주는 피해', value: 0.65 }]
      },
      {
        id: ID.GUILLOTINE_SPIN.T1_2, name: { text: NAMES[ID.GUILLOTINE_SPIN.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.GUILLOTINE_SPIN.T1_2}.webp`,
        slot: 1, index: 2,
        effects: [{
          type: 'DMG_INC', value: { value: 0.35 },
          target: { skillIds: [ NAMES[ID.GUILLOTINE_SPIN.BODY] ] }
        }]
      },
      {
        id: ID.GUILLOTINE_SPIN.T1_3, name: { text: NAMES[ID.GUILLOTINE_SPIN.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.GUILLOTINE_SPIN.T2_1, name: { text: NAMES[ID.GUILLOTINE_SPIN.T2_1] },
  ...
  // ────── 임페일 쇼크 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.PIERCING_SHOCK.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.PIERCING_SHOCK.T1_1, name: { text: NAMES[ID.PIERCING_SHOCK.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.PIERCING_SHOCK.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '기운 추가 회복', value: 3 }]
      },
      {
        id: ID.PIERCING_SHOCK.T1_2, name: { text: NAMES[ID.PIERCING_SHOCK.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.PIERCING_SHOCK.T1_2}.webp`,
        slot: 1, index: 2,
        memo: [{ type: '오브 게이지 회복량 증가', value: 0.3 }]
      },
      {
        id: ID.PIERCING_SHOCK.T1_3, name: { text: NAMES[ID.PIERCING_SHOCK.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.PIERCING_SHOCK.T2_1, name: { text: NAMES[ID.PIERCING_SHOCK.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.PIERCING_SHOCK.T2_1}.webp`,
        slot: 2, index: 1,
        overrides: { typeId: 'CHARGE' },
        effects: [{
          type: 'DMG_INC', value: { value: 0.7 },
          target: { skillIds: [ NAMES[ID.PIERCING_SHOCK.BODY] ] }
        }]
      },
      {
        id: ID.PIERCING_SHOCK.T2_2, name: { text: NAMES[ID.PIERCING_SHOCK.T2_2] },
        iconPath: `/images/skills/guardian-knight/${ID.PIERCING_SHOCK.T2_2}.webp`,
        slot: 2, index: 2,
        effects: [
          {
          type: 'DMG_INC', value: { value: 1.4 },
          target: { skillIds: [ NAMES[ID.PIERCING_SHOCK.BODY] ] }
          },
          {
          type: 'CDR_C', value: { value: 6 },
          target: { skillIds: [ NAMES[ID.PIERCING_SHOCK.BODY] ] }
          }
        ]
      },
      {
        id: ID.PIERCING_SHOCK.T2_3, name: { text: NAMES[ID.PIERCING_SHOCK.T2_3] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.PIERCING_SHOCK.T3_1, name: { text: NAMES[ID.PIERCING_SHOCK.T3_1] },
      ...
      {
        id: ID.PIERCING_SHOCK.T3_2, name: { text: NAMES[ID.PIERCING_SHOCK.T3_2] },
  ...
  // ────── 미티어 크래시 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.METEOR_CRASH.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.METEOR_CRASH.T1_1, name: { text: NAMES[ID.METEOR_CRASH.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.METEOR_CRASH.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '피격 시 받는 피해 감소', value: 0.2 }]
      },
      {
        id: ID.METEOR_CRASH.T1_2, name: { text: NAMES[ID.METEOR_CRASH.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.METEOR_CRASH.T1_2}.webp`,
        slot: 1, index: 2,
        memo: [{ type: '오브 게이지 회복량 증가', value: 0.3 }]
      },
      {
        id: ID.METEOR_CRASH.T1_3, name: { text: NAMES[ID.METEOR_CRASH.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.METEOR_CRASH.T2_1, name: { text: NAMES[ID.METEOR_CRASH.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.METEOR_CRASH.T2_1}.webp`,
        slot: 2, index: 1,
        effects: [{
          type: 'DMG_INC', value: { value: 0.3 },
          target: { skillIds: [ NAMES[ID.METEOR_CRASH.BODY] ] }
        }]
      },
      {
        id: ID.METEOR_CRASH.T2_2, name: { text: NAMES[ID.METEOR_CRASH.T2_2] },
      ...
      {
        id: ID.METEOR_CRASH.T2_3, name: { text: NAMES[ID.METEOR_CRASH.T2_3] },
        iconPath: `/images/skills/guardian-knight/${ID.METEOR_CRASH.T2_3}.webp`,
        slot: 2, index: 3,
        effects: [{
          type: 'DMG_INC', value: { value: 0.45 },
          target: { skillIds: [ NAMES[ID.METEOR_CRASH.BODY] ] }
        }]
      },
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.METEOR_CRASH.T3_1, name: { text: NAMES[ID.METEOR_CRASH.T3_1] },
      ...
      {
        id: ID.METEOR_CRASH.T3_2, name: { text: NAMES[ID.METEOR_CRASH.T3_2] },
  ...
  // ────── 퀘이크 스매시 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.QUAKE_SMASH.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.QUAKE_SMASH.T1_1, name: { text: NAMES[ID.QUAKE_SMASH.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.QUAKE_SMASH.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '피격 시 받는 피해 감소', value: 0.2 }]
      },
      {
        id: ID.QUAKE_SMASH.T1_2, name: { text: NAMES[ID.QUAKE_SMASH.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.QUAKE_SMASH.T1_2}.webp`,
        slot: 1, index: 2,
        overrides: { destruction: 3 } // 부위 파괴 +1
      },
      {
        id: ID.QUAKE_SMASH.T1_3, name: { text: NAMES[ID.QUAKE_SMASH.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.QUAKE_SMASH.T2_1, name: { text: NAMES[ID.QUAKE_SMASH.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.QUAKE_SMASH.T2_1}.webp`,
        slot: 2, index: 1,
        overrides: { typeId: 'NORMAL' },
        effects: [{
          type: 'DMG_INC', value: { value: 0.8 },
          target: { skillIds: [ NAMES[ID.QUAKE_SMASH.BODY] ] }
        }],
        memo: [{ type: '기운 추가 회복', value: 2 }]
      },
      {
        id: ID.QUAKE_SMASH.T2_2, name: { text: NAMES[ID.QUAKE_SMASH.T2_2] },
        iconPath: `/images/skills/guardian-knight/${ID.QUAKE_SMASH.T2_2}.webp`,
        slot: 2, index: 2,
        overrides: { typeId: 'CHARGE' },
        effects: [{
          type: 'DMG_INC', value: { value: 1.85 },
          target: { skillIds: [ NAMES[ID.QUAKE_SMASH.BODY] ] }
        }]
      },
      {
        id: ID.QUAKE_SMASH.T2_3, name: { text: NAMES[ID.QUAKE_SMASH.T2_3] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.QUAKE_SMASH.T3_1, name: { text: NAMES[ID.QUAKE_SMASH.T3_1] },
      ...
      {
        id: ID.QUAKE_SMASH.T3_2, name: { text: NAMES[ID.QUAKE_SMASH.T3_2] },
        iconPath: `/images/skills/guardian-knight/${ID.QUAKE_SMASH.T3_2}.webp`,
        slot: 3, index: 2,
        overrides: { superArmorId: 'PUSH_IMMUNE' },
        effects: [{
          type: 'DMG_INC', value: { value: 0.95 },
          target: { skillIds: [ NAMES[ID.QUAKE_SMASH.BODY] ] }
        }]
      }
    ]
  ...
  // ────── 프렌지 스윕 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.FRENZY_SWEEP.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.FRENZY_SWEEP.T1_1, name: { text: NAMES[ID.FRENZY_SWEEP.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.FRENZY_SWEEP.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '피격 시 받는 피해 감소', value: 0.2 }]
      },
      {
        id: ID.FRENZY_SWEEP.T1_2, name: { text: NAMES[ID.FRENZY_SWEEP.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.FRENZY_SWEEP.T1_2}.webp`,
        slot: 1, index: 2,
        overrides: { stagger: '상' }
      },
      {
        id: ID.FRENZY_SWEEP.T1_3, name: { text: NAMES[ID.FRENZY_SWEEP.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.FRENZY_SWEEP.T2_1, name: { text: NAMES[ID.FRENZY_SWEEP.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.FRENZY_SWEEP.T2_1}.webp`,
        slot: 2, index: 1,
        effects: [{
          type: 'DMG_INC', value: { value: 1.755 },
          target: { skillIds: [ NAMES[ID.FRENZY_SWEEP.BODY] ] }
        }]
      },
      {
        id: ID.FRENZY_SWEEP.T2_2, name: { text: NAMES[ID.FRENZY_SWEEP.T2_2] },
        iconPath: `/images/skills/guardian-knight/${ID.FRENZY_SWEEP.T2_2}.webp`,
        slot: 2, index: 2,
        effects: [{
          type: 'DMG_INC', value: { value: 1.44 },
          target: { skillIds: [ NAMES[ID.FRENZY_SWEEP.BODY] ] }
        }]
      },
      {
        id: ID.FRENZY_SWEEP.T2_3, name: { text: NAMES[ID.FRENZY_SWEEP.T2_3] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.FRENZY_SWEEP.T3_1, name: { text: NAMES[ID.FRENZY_SWEEP.T3_1] },
        iconPath: `/images/skills/guardian-knight/${ID.FRENZY_SWEEP.T3_1}.webp`,
        slot: 3, index: 1,
        effects: [{
          type: 'DMG_INC', value: { value: 0.84 },
          target: { skillIds: [ NAMES[ID.FRENZY_SWEEP.BODY] ] }
        }]
      },
      {
        id: ID.FRENZY_SWEEP.T3_2, name: { text: NAMES[ID.FRENZY_SWEEP.T3_2] },
  ...
  // ────── 리벤지 블로우 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.VENGEFUL_BLOW.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.VENGEFUL_BLOW.T1_1, name: { text: NAMES[ID.VENGEFUL_BLOW.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.VENGEFUL_BLOW.T1_1}.webp`,
        slot: 1, index: 1,
        effects: [{
          type: 'GK_QI_DMG', value: { value: 0.05 },
          target: { skillIds: [ NAMES[ID.VENGEFUL_BLOW.BODY] ] }
        }]
      },
      {
        id: ID.VENGEFUL_BLOW.T1_2, name: { text: NAMES[ID.VENGEFUL_BLOW.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.VENGEFUL_BLOW.T1_2}.webp`,
        slot: 1, index: 2,
        overrides: { attackId: 'NON_DIRECTIONAL' },
        effects: [{
          type: 'DMG_INC', value: { value: 0.15 },
          target: { skillIds: [ NAMES[ID.VENGEFUL_BLOW.BODY] ] }
        }]
      },
      {
        id: ID.VENGEFUL_BLOW.T1_3, name: { text: NAMES[ID.VENGEFUL_BLOW.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.VENGEFUL_BLOW.T2_1, name: { text: NAMES[ID.VENGEFUL_BLOW.T2_1] },
      ...
      {
        id: ID.VENGEFUL_BLOW.T2_2, name: { text: NAMES[ID.VENGEFUL_BLOW.T2_2] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.VENGEFUL_BLOW.T3_1, name: { text: NAMES[ID.VENGEFUL_BLOW.T3_1] },
      ...
      {
        id: ID.VENGEFUL_BLOW.T3_2, name: { text: NAMES[ID.VENGEFUL_BLOW.T3_2] },
  ...
  // ────── 리벤지 스피어 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.AVENGING_SPEAR.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.AVENGING_SPEAR.T1_1, name: { text: NAMES[ID.AVENGING_SPEAR.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.AVENGING_SPEAR.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '피격 시 데미지 감소', value: 0.2 }]
      },
      {
        id: ID.AVENGING_SPEAR.T1_2, name: { text: NAMES[ID.AVENGING_SPEAR.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.AVENGING_SPEAR.T1_2}.webp`,
        slot: 1, index: 2,
        effects: [{
          type: 'GK_QI_DMG', value: { value: 0.1 },
          target: { skillIds: [ NAMES[ID.AVENGING_SPEAR.BODY] ] }
        }]
      },
      {
        id: ID.AVENGING_SPEAR.T1_3, name: { text: NAMES[ID.AVENGING_SPEAR.T1_3] },
        iconPath: `/images/skills/guardian-knight/${ID.AVENGING_SPEAR.T1_3}.webp`,
        slot: 1, index: 3
      },
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.AVENGING_SPEAR.T2_1, name: { text: NAMES[ID.AVENGING_SPEAR.T2_1] },
      ...
      {
        id: ID.AVENGING_SPEAR.T2_2, name: { text: NAMES[ID.AVENGING_SPEAR.T2_2] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.AVENGING_SPEAR.T3_1, name: { text: NAMES[ID.AVENGING_SPEAR.T3_1] },
      ...
      {
        id: ID.AVENGING_SPEAR.T3_2, name: { text: NAMES[ID.AVENGING_SPEAR.T3_2] },
        iconPath: `/images/skills/guardian-knight/${ID.AVENGING_SPEAR.T3_2}.webp`,
        slot: 3, index: 2,
        link: { slot: 2, index: 2 },
        effects: [{
          type: 'DMG_INC', value: { value: 2.8 },
          target: { skillIds: [ NAMES[ID.AVENGING_SPEAR.BODY] ] }
        }],
      }
    ]
  ...
  // ────── 스피닝 플레임 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.SPINNING_FLAME.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.SPINNING_FLAME.T1_1, name: { text: NAMES[ID.SPINNING_FLAME.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.SPINNING_FLAME.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '적 받는 피해 증가', value: 0.06 }]
      },
      {
        id: ID.SPINNING_FLAME.T1_2, name: { text: NAMES[ID.SPINNING_FLAME.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.SPINNING_FLAME.T1_2}.webp`,
        slot: 1, index: 2,
        memo: [{ type: '오브 게이지 회복량 증가', value: 0.3 }]
      },
      {
        id: ID.SPINNING_FLAME.T1_3, name: { text: NAMES[ID.SPINNING_FLAME.T1_3] },
        iconPath: `/images/skills/guardian-knight/${ID.SPINNING_FLAME.T1_3}.webp`,
        slot: 1, index: 3,
        effects: [{
          type: 'GK_QI_DMG', value: { value: 0.05 },
          target: { skillIds: [ NAMES[ID.SPINNING_FLAME.BODY] ] }
        }]
      },
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.SPINNING_FLAME.T2_1, name: { text: NAMES[ID.SPINNING_FLAME.T2_1] },
      ...
      {
        id: ID.SPINNING_FLAME.T2_2, name: { text: NAMES[ID.SPINNING_FLAME.T2_2] },
        iconPath: `/images/skills/guardian-knight/${ID.SPINNING_FLAME.T2_2}.webp`,
        slot: 2, index: 2,
        effects: [{
          type: 'DMG_INC', value: { value: 0.5 },
          target: { skillIds: [ NAMES[ID.SPINNING_FLAME.BODY] ] }
        }]
      },
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.SPINNING_FLAME.T3_1, name: { text: NAMES[ID.SPINNING_FLAME.T3_1] },
      ...
      {
        id: ID.SPINNING_FLAME.T3_2, name: { text: NAMES[ID.SPINNING_FLAME.T3_2] },
  ...
  // ────── 아바돈 플레임 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.ABADDON_FLAME.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.ABADDON_FLAME.T1_1, name: { text: NAMES[ID.ABADDON_FLAME.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.ABADDON_FLAME.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '적 받는 피해 증가', value: 0.06 }]
      },
      {
        id: ID.ABADDON_FLAME.T1_2, name: { text: NAMES[ID.ABADDON_FLAME.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.ABADDON_FLAME.T1_2}.webp`,
        slot: 1, index: 2,
        effects: [{
          type: 'GK_QI_COST', value: { value: 2 },
          target: { skillIds: [ NAMES[ID.ABADDON_FLAME.BODY] ] }
        }]
      },
      {
        id: ID.ABADDON_FLAME.T1_3, name: { text: NAMES[ID.ABADDON_FLAME.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.ABADDON_FLAME.T2_1, name: { text: NAMES[ID.ABADDON_FLAME.T2_1] },
      ...
      {
        id: ID.ABADDON_FLAME.T2_2, name: { text: NAMES[ID.ABADDON_FLAME.T2_2] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.ABADDON_FLAME.T3_1, name: { text: NAMES[ID.ABADDON_FLAME.T3_1] },
        iconPath: `/images/skills/guardian-knight/${ID.ABADDON_FLAME.T3_1}.webp`,
        slot: 3, index: 1,
        link: { slot: 2, index: 1 },
        effects: [{
          type: 'DMG_INC', value: { value: 0.92 },
          target: { skillIds: [ NAMES[ID.ABADDON_FLAME.BODY] ] }
        }]
      },
      {
        id: ID.ABADDON_FLAME.T3_2, name: { text: NAMES[ID.ABADDON_FLAME.T3_2] },
        iconPath: `/images/skills/guardian-knight/${ID.ABADDON_FLAME.T3_2}.webp`,
        slot: 3, index: 2,
        link: { slot: 2, index: 2 },
        effects: [{
          type: 'DMG_INC', value: { value: 1.8 },
          target: { skillIds: [ NAMES[ID.ABADDON_FLAME.BODY] ] }
        }]
      }
    ]
  ...
  // ────── 윙 스팅어 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.SOARING_STRIKE.BODY] },
    ...
    destruction: 1,
    stagger: '하',
    superArmorId: 'STIFF_IMMUNE', // 경직 면역
    cooldown: 9,
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.SOARING_STRIKE.T1_1, name: { text: NAMES[ID.SOARING_STRIKE.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.SOARING_STRIKE.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '시전 속도 증가', value: 0.1 }]
      },
      {
        id: ID.SOARING_STRIKE.T1_2, name: { text: NAMES[ID.SOARING_STRIKE.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.SOARING_STRIKE.T1_2}.webp`,
        slot: 1, index: 2,
        memo: [{ type: '오브 게이지 회복량 증가', value: 0.3 }]
      },
      {
        id: ID.SOARING_STRIKE.T1_3, name: { text: NAMES[ID.SOARING_STRIKE.T1_3] },
        iconPath: `/images/skills/guardian-knight/${ID.SOARING_STRIKE.T1_3}.webp`,
        slot: 1, index: 3,
        effects: [{
          type: 'GK_QI_DMG', value: { value: 0.05 },
          target: { skillIds: [ NAMES[ID.SOARING_STRIKE.BODY] ] }
        }]
      },
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.SOARING_STRIKE.T2_1, name: { text: NAMES[ID.SOARING_STRIKE.T2_1] },
      ...
      {
        id: ID.SOARING_STRIKE.T2_2, name: { text: NAMES[ID.SOARING_STRIKE.T2_2] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.SOARING_STRIKE.T3_1, name: { text: NAMES[ID.SOARING_STRIKE.T3_1] },
      ...
      {
        id: ID.SOARING_STRIKE.T3_2, name: { text: NAMES[ID.SOARING_STRIKE.T3_2] },
        iconPath: `/images/skills/guardian-knight/${ID.SOARING_STRIKE.T3_2}.webp`,
        slot: 3, index: 2,
        link: { slot: 2, index: 2 },
        overrides: { superArmorId: 'PUSH_IMMUNE' }, // 피격 이상 면역 추가
        effects: [{
          type: 'DMG_INC', value: { value: 0.7 },
          target: { skillIds: [ NAMES[ID.SOARING_STRIKE.BODY] ] }
        }]
  ...
  // ────── 윙 래시 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.WING_LASH.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.WING_LASH.T1_1, name: { text: NAMES[ID.WING_LASH.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.WING_LASH.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '시전 속도 증가', value: 0.1 }]
      },
      {
        id: ID.WING_LASH.T1_2, name: { text: NAMES[ID.WING_LASH.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.WING_LASH.T1_2}.webp`,
        slot: 1, index: 2,
        effects: [{
          type: 'GK_QI_COST', value: { value: 2 },
          target: { skillIds: [ NAMES[ID.WING_LASH.BODY] ] }
        }]
      },
      {
        id: ID.WING_LASH.T1_3, name: { text: NAMES[ID.WING_LASH.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.WING_LASH.T2_1, name: { text: NAMES[ID.WING_LASH.T2_1] },
      ...
      {
        id: ID.WING_LASH.T2_2, name: { text: NAMES[ID.WING_LASH.T2_2] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.WING_LASH.T3_1, name: { text: NAMES[ID.WING_LASH.T3_1] },
  ...
  // ────── 블레이즈 스윕 ────────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.BLAZE_SWEEP.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.BLAZE_SWEEP.T1_1, name: { text: NAMES[ID.BLAZE_SWEEP.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.BLAZE_SWEEP.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '돌진 시전 속도 증가', value: 0.2 }]
      },
      {
        id: ID.BLAZE_SWEEP.T1_2, name: { text: NAMES[ID.BLAZE_SWEEP.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.BLAZE_SWEEP.T1_2}.webp`,
        slot: 1, index: 2,
        memo: [{ type: '적중한 적 1명 당 쿨타임 감소(1명 당 0.5초)', value: 6}]
      },
      {
        id: ID.BLAZE_SWEEP.T1_3, name: { text: NAMES[ID.BLAZE_SWEEP.T1_3] },
        iconPath: `/images/skills/guardian-knight/${ID.BLAZE_SWEEP.T1_3}.webp`,
        slot: 1, index: 3,
        overrides: { attackId: 'NON_DIRECTIONAL' },
        effects: [{
          type: 'DMG_INC', value: { value: 0.15 },
          target: { skillIds: [ NAMES[ID.BLAZE_SWEEP.BODY] ] }
        }]
      },
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.BLAZE_SWEEP.T2_1, name: { text: NAMES[ID.BLAZE_SWEEP.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.BLAZE_SWEEP.T2_1}.webp`,
        slot: 2, index: 1,
        effects: [{
          type: 'DMG_INC', value: { value: 0.96 },
          target: { skillIds: [ NAMES[ID.BLAZE_SWEEP.BODY] ] }
        }]
      },
      {
        id: ID.BLAZE_SWEEP.T2_2, name: { text: NAMES[ID.BLAZE_SWEEP.T2_2] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.BLAZE_SWEEP.T3_1, name: { text: NAMES[ID.BLAZE_SWEEP.T3_1] },
      ...
      {
        id: ID.BLAZE_SWEEP.T3_2, name: { text: NAMES[ID.BLAZE_SWEEP.T3_2] },
  ...
  // ────── 블레이즈 플래시 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.BLAZE_FLASH.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.BLAZE_FLASH.T1_1, name: { text: NAMES[ID.BLAZE_FLASH.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.BLAZE_FLASH.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '최초 돌진 시전 속도 증가', value: 0.2 }]
      },
      {
        id: ID.BLAZE_FLASH.T1_2, name: { text: NAMES[ID.BLAZE_FLASH.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.BLAZE_FLASH.T1_2}.webp`,
        slot: 1, index: 2,
        memo: [{ type: '적중한 적 1명 당 쿨타임 감소(1명 당 0.5초)', value: 6 }]
      },
      {
        id: ID.BLAZE_FLASH.T1_3, name: { text: NAMES[ID.BLAZE_FLASH.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.BLAZE_FLASH.T2_1, name: { text: NAMES[ID.BLAZE_FLASH.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.BLAZE_FLASH.T2_1}.webp`,
        slot: 2, index: 1,
        effects: [{
          type: 'DMG_INC', value: { value: 0.6 },
          target: { skillIds: [ NAMES[ID.BLAZE_FLASH.BODY] ] }
        }]
      },
      {
        id: ID.BLAZE_FLASH.T2_2, name: { text: NAMES[ID.BLAZE_FLASH.T2_2] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.BLAZE_FLASH.T3_1, name: { text: NAMES[ID.BLAZE_FLASH.T3_1] },
        iconPath: `/images/skills/guardian-knight/${ID.BLAZE_FLASH.T3_1}.webp`,
        slot: 3, index: 1,
        link: { slot: 2, index: 1 },
        effects: [{
          type: 'DMG_INC', value: { value: 1.5 },
          target: { skillIds: [ NAMES[ID.BLAZE_FLASH.BODY] ] }
        }]
      },
      {
        id: ID.BLAZE_FLASH.T3_2, name: { text: NAMES[ID.BLAZE_FLASH.T3_2] },
  ...
  // ────── 렌딩 피니셔 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.RENDING_FINISHER.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.RENDING_FINISHER.T1_1, name: { text: NAMES[ID.RENDING_FINISHER.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.RENDING_FINISHER.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '시전 속도 증가', value: 0.15 }]
      },
      {
        id: ID.RENDING_FINISHER.T1_2, name: { text: NAMES[ID.RENDING_FINISHER.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.RENDING_FINISHER.T1_2}.webp`,
        slot: 1, index: 2,
        memo: [{ type: '받는 피해 감소', value: 0.2 }]
      },
      {
        id: ID.RENDING_FINISHER.T1_3, name: { text: NAMES[ID.RENDING_FINISHER.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.RENDING_FINISHER.T2_1, name: { text: NAMES[ID.RENDING_FINISHER.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.RENDING_FINISHER.T2_1}.webp`,
        slot: 2, index: 1,
        overrides: { typeId: 'CHARGE', superArmorId: 'PUSH_IMMUNE' },
        effects: [{
          type: 'DMG_INC', value: { value: 0.5 },
          target: { skillIds: [ NAMES[ID.RENDING_FINISHER.BODY] ] }
        }]
      },
      {
        id: ID.RENDING_FINISHER.T2_2, name: { text: NAMES[ID.RENDING_FINISHER.T2_2] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.RENDING_FINISHER.T3_1, name: { text: NAMES[ID.RENDING_FINISHER.T3_1] },
      ...
      {
        id: ID.RENDING_FINISHER.T3_2, name: { text: NAMES[ID.RENDING_FINISHER.T3_2] },
  ...
  // ────── 익스플로전 피니셔 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.EXPLOSION_FINISHER.BODY] },
    ...
    tripods: [
      // ── 1티어 ─────────────────────────────────────────────
      {
        id: ID.EXPLOSION_FINISHER.T1_1, name: { text: NAMES[ID.EXPLOSION_FINISHER.T1_1] },
        iconPath: `/images/skills/guardian-knight/${ID.EXPLOSION_FINISHER.T1_1}.webp`,
        slot: 1, index: 1,
        memo: [{ type: '시전 속도 증가', value: 0.1 }]
      },
      {
        id: ID.EXPLOSION_FINISHER.T1_2, name: { text: NAMES[ID.EXPLOSION_FINISHER.T1_2] },
        iconPath: `/images/skills/guardian-knight/${ID.EXPLOSION_FINISHER.T1_2}.webp`,
        slot: 1, index: 2,
        memo: [{ type: '받는 피해 감소', value: 0.2 }]
      },
      {
        id: ID.EXPLOSION_FINISHER.T1_3, name: { text: NAMES[ID.EXPLOSION_FINISHER.T1_3] },
      ...
      // ── 2티어 ─────────────────────────────────────────────
      {
        id: ID.EXPLOSION_FINISHER.T2_1, name: { text: NAMES[ID.EXPLOSION_FINISHER.T2_1] },
        iconPath: `/images/skills/guardian-knight/${ID.EXPLOSION_FINISHER.T2_1}.webp`,
        slot: 2, index: 1,
        overrides: { typeId: 'CHARGE', superArmorId: 'PUSH_IMMUNE' },
        effects: [{
          type: 'DMG_INC', value: { value: 0.7 },
          target: { skillIds: [ NAMES[ID.EXPLOSION_FINISHER.BODY] ] }
        }]
      },
      {
        id: ID.EXPLOSION_FINISHER.T2_2, name: { text: NAMES[ID.EXPLOSION_FINISHER.T2_2] },
      ...
      // ── 3티어 ─────────────────────────────────────────────
      {
        id: ID.EXPLOSION_FINISHER.T3_1, name: { text: NAMES[ID.EXPLOSION_FINISHER.T3_1] },
        iconPath: `/images/skills/guardian-knight/${ID.EXPLOSION_FINISHER.T3_1}.webp`,
        slot: 3, index: 1,
        link: { slot: 2, index: 1 },
        effects: [
          {
            type: 'DMG_INC', value: { value: 0.75 },
            target: { skillIds: [ NAMES[ID.EXPLOSION_FINISHER.BODY] ] }
          }
        ],
        addDamageSources: {
      ...
      {
        id: ID.EXPLOSION_FINISHER.T3_2, name: { text: NAMES[ID.EXPLOSION_FINISHER.T3_2] },
  ...
  // ────── 소울 디바이드 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.SOUL_DIVIDE.BODY] },
  ...
  // ────── 딥 임팩트 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.DEEP_IMPACT.BODY] },
  ...
  // ────── 가디언 백래시 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.GUARDIAN_BACKLASH.BODY] },
  ...
  // ────── 브레스 오브 엠버레스 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.BREATH_OF_EMBERES.BODY] },
  ...
  // ────── 가디언즈 크래시 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.GUARDIANS_CRASH.BODY] },
  ...
  {
    id: ID.AWAKEN.BODY,
    name: { text: NAMES[ID.AWAKEN.BODY] },
  ...
  // ────── 인페르노 버스트 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.INFERNO_BURST.BODY] },
  ...
  // ────── 가디언 피어 ──────────────────────────────────
  {
    ...
    name: { text: NAMES[ID.GUARDIAN_FEAR.BODY] },
